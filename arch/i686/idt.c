...
void init_idt(void)
{
    ...
    fill_idt_entry(0, (uint32_t)eh0, 0x08, 0x8F);
    fill_idt_entry(1, (uint32_t)eh1, 0x08, 0x8F);
    fill_idt_entry(2, (uint32_t)eh2, 0x08, 0x8F);
    fill_idt_entry(3, (uint32_t)eh3, 0x08, 0x8F);
    fill_idt_entry(4, (uint32_t)eh4, 0x08, 0x8F);
    fill_idt_entry(5, (uint32_t)eh5, 0x08, 0x8F);
    fill_idt_entry(6, (uint32_t)eh6, 0x08, 0x8F);
    fill_idt_entry(7, (uint32_t)eh7, 0x08, 0x8F);
    fill_idt_entry(8, (uint32_t)eh8, 0x08, 0x8F);
    fill_idt_entry(9, (uint32_t)eh9, 0x08, 0x8F);
    fill_idt_entry(10, (uint32_t)eh10, 0x08, 0x8F);
    fill_idt_entry(11, (uint32_t)eh11, 0x08, 0x8F);
    fill_idt_entry(12, (uint32_t)eh12, 0x08, 0x8F);
    fill_idt_entry(13, (uint32_t)eh13, 0x08, 0x8F);
    fill_idt_entry(14, (uint32_t)eh14, 0x08, 0x8F);
    fill_idt_entry(15, (uint32_t)eh15, 0x08, 0x8F);
    fill_idt_entry(16, (uint32_t)eh16, 0x08, 0x8F);
    fill_idt_entry(17, (uint32_t)eh17, 0x08, 0x8F);
    fill_idt_entry(18, (uint32_t)eh18, 0x08, 0x8F);
    fill_idt_entry(19, (uint32_t)eh19, 0x08, 0x8F);
    fill_idt_entry(20, (uint32_t)eh20, 0x08, 0x8F);
    fill_idt_entry(21, (uint32_t)eh21, 0x08, 0x8F);
    fill_idt_entry(22, (uint32_t)eh22, 0x08, 0x8F);
    fill_idt_entry(23, (uint32_t)eh23, 0x08, 0x8F);
    fill_idt_entry(24, (uint32_t)eh24, 0x08, 0x8F);
    fill_idt_entry(25, (uint32_t)eh25, 0x08, 0x8F);
    fill_idt_entry(26, (uint32_t)eh26, 0x08, 0x8F);
    fill_idt_entry(27, (uint32_t)eh27, 0x08, 0x8F);
    fill_idt_entry(28, (uint32_t)eh28, 0x08, 0x8F);
    fill_idt_entry(29, (uint32_t)eh29, 0x08, 0x8F);
    fill_idt_entry(30, (uint32_t)eh30, 0x08, 0x8F);
    fill_idt_entry(31, (uint32_t)eh31, 0x08, 0x8F);
